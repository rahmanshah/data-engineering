...
CREATE OR REFRESH STREAMING TABLE customers (
  ...
  __START_AT TIMESTAMP COMMENT "SCD Type 2 start timestamp for the record version.",
  __END_AT TIMESTAMP COMMENT "SCD Type 2 end timestamp for the record version."
)
